...
public class VehicleRepository : IVehicleRepository
{
    ...
    {
        var addVehicle = new Vehicle(vehicle.Name, vehicle.VehicleRegistrationPlate, vehicle.TruckType, vehicle.WheelType, vehicle.BodyType);
    ...
    public async Task<bool?> UpdateVehicleAsync(Guid id, VehicleResponse vehicle)
    {
        ...
        vehicleToUpdate.UpdateVehicle(vehicle.Name, vehicle.VehicleRegistrationPlate, vehicle.TruckType, vehicle.WheelType, vehicle.BodyType);
