...
namespace TMS.Infrastructure.Migrations
{
    ...
    [Migration("20250624222601_UpdatingTravel")]
    partial class UpdatingTravel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMS.Domain.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TMS.Domain.Entities.Address", b =>
                {
                    b.HasOne("TMS.Domain.Entites.Travel", "Travel")
                        .WithMany()
                        .HasForeignKey("TravelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TMS.Domain.Entites.Travel", null)
                        .WithMany("Address")
